...
- [ ] 1. Migrate pom.xml to Spring Boot 3.x / Java 21
...
- [ ] 2. Create Spring Boot application entry point and base package structure
...
- [ ] 3. Implement domain layer — Withdrawal value object
...
- [ ] 4. Implement application layer — port, model, and use cases
  - [ ] 4.1 Create `TimeDepositRepository` port interface
  ...
  - [ ] 4.2 Create `TimeDepositView` application model
  ...
  - [ ] 4.3 Implement `GetAllTimeDepositsUseCase`
  ...
  - [ ] 4.4 Implement `UpdateBalancesUseCase`
  ...
  - [ ]* 4.5 Write unit tests for use-case orchestration
...
- [ ] 5. Implement infrastructure persistence layer
  - [ ] 5.1 Create JPA entities `TimeDepositEntity` and `WithdrawalEntity`
  ...
  - [ ] 5.2 Create Spring Data repositories
  ...
  - [ ] 5.3 Implement `TimeDepositJpaAdapter`
  ...
  - [ ]* 5.4 Write unit tests for mapper logic
...
- [ ] 6. Implement infrastructure REST layer
  - [ ] 6.1 Create response DTOs
  ...
  - [ ] 6.2 Implement `TimeDepositController`
  ...
  - [ ]* 6.3 Write MockMvc unit tests for the controller
...
- [ ] 8. Add OpenAPI / Swagger documentation
  ...
  - [ ]* 8.1 Write test verifying OpenAPI endpoints are reachable
